...
class AuctionListing(models.Model):
    ...
    image_url = models.ImageField(upload_to='images/', default='https://user-images.githubusercontent.com/52632898/161646398-6d49eca9-267f-4eab-a5a7-6ba6069d21df.png')
...
class Watchlist(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    auctionitem = models.ManyToManyField(AuctionListing, related_name="auction_listing")
    created_at = models.DateTimeField(auto_now_add=True)
